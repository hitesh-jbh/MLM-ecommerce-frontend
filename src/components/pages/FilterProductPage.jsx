...
// //         { id: 9, name: 'Hooded Sweatshirt', price: 120.00, brand: 'Puma', category: 'Sweatshirts', rating: 4.9, reviews: 245, image: 'https://gentlehaus.in/cdn/shop/files/1_d38494bd-b788-4b6e-b819-9ab069318e1f.webp?v=1754281625&width=1240', stock: 3 },
// //     ];
...
// //                 {/* Sidebar */}
// //                 <aside className={`
// //           fixed md:static inset-y-0 left-0 z-[200] w-full md:w-80 bg-white border-r border-gray-200 
...
// //                                 <div
// //                                     key={product.id}
// //                                     className="group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-amber-100"
// //                                 >
// //                                     {/* Product Image */}
...
// //                                             </div>
// //                                         ) : (
// //                                             <div className={`w-full h-full ${product.image} flex items-center justify-center relative`}>
// //                                                 <div className="absolute inset-0 bg-gradient-to-t from-black/5 to-transparent" />
// //                                                 <div className="relative z-10 text-4xl opacity-20">
// //                                                     {product.brand === 'Nike' && '🔺'}
// //                                                     {product.brand === 'Adidas' && '〽️'}
// //                                                     {product.brand === 'Puma' && '🐆'}
...
// //                                             <span className="bg-gradient-to-r from-black to-amber-900 text-white text-[8px] px-3 py-1.5 rounded-full font-medium shadow-lg">
// //                                                 ★ New Arrival
// //                                             </span>
// //                                         </div>
...
// //                                             className="absolute top-1 right-1 bg-white/5 backdrop-blur-sm p-2 rounded-full shadow-lg hover:scale-110 active:scale-95 transition-all duration-200"
// //                                         >
// //                                             <Heart
// //                                                 size={20}
// //                                                 className={`transition-colors ${favorites.includes(product.id) ? 'fill-red-500 text-red-500' : 'text-gray-600'}`}
// //                                             />
// //                                         </button>

// //                                         <div className="absolute bottom-1 left-1 right-1">
// //                                             <button className="w-full bg-gradient-to-r text-sm from-amber-900 to-black text-white font-medium py-1 rounded-lg opacity-0 group-hover:opacity-60 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 hover:shadow-lg">
...
// //                                         <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-amber-900 transition-colors line-clamp-1">
// //                                             {product.name}
// //                                         </h3>

// //                                         <p className="text-xs  text-gray-500 mb-4">by {product.brand}</p>
...
// //                                             <div className={`text-[8px] font-medium px-3 py-1 rounded-full ${product.stock > 10
...
// //                                                 </div>
// //                                             ) : (
// //                                                 <div className={`w-full h-48 md:h-full ${product.image} flex items-center justify-center`}>
// //                                                 </div>
// //                                             )}
// //                                             <div className="absolute top-3 left-3">
// //                                                 <span className="bg-gradient-to-r from-cyan-500 to-amber-900 text-white text-xs px-3 py-1 rounded-full">
// //                                                     New
// //                                                 </span>
// //                                             </div>
// //                                             <button
...
// //                                                     </span>
// //                                                     <button className="px-6 py-2 bg-gradient-to-r from-amber-600 to-amber-900 text-white font-medium rounded-lg hover:shadow-lg transition-shadow">
// //                                                         Add to Cart
// //                                                     </button>
// //                                                 </div>
// //                                             </div>
...
// //                                                 </div>
// //                                                 <button className="text-amber-600 hover:text-amber-900 font-medium text-sm">
// //                                                     View Details →
// //                                                 </button>
// //                                             </div>
// //                                         </div>
...
//                 {/* Sidebar */}
//                 <aside className={`
//           fixed md:static inset-y-0 left-0 z-[200] md:z-[90] w-full md:w-80 bg-white border-r border-gray-200 
//           transform transition-transform duration-300 ease-in-out md:translate-x-0
//           ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:block
//           h-screen overflow-y-auto
//         `}>
