...
function ProductMgt() {
    ...
    const [isSubmitting, setIsSubmitting] = useState(false); // Renamed to distinguish from SWR loading
    const [error, setError] = useState(null);

    // --- Data Fetching with SWR ---
    // This uses the global fetcher you defined in SWRConfig
    const { data, error: swrError, mutate, isLoading } = useSWR('/product/');
