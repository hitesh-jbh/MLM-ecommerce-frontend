...
const UserSidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const menuItems = [
    { id: 'profile', name: 'Profile', icon: "heroicons:user", link: '/profile/me' },
    { id: 'order', name: 'Your Orders', icon: "heroicons:shopping-bag", link: '/profile/your-order' },
    { id: 'address', name: 'Your Address', icon: "heroicons:map-pin", link: '/profile/address' },
    { id: 'payment', name: 'Payment Options', icon: "heroicons:credit-card", link: '/profile/payment' },
    {id: 'whislist', name: 'Your Whislist', icon: "solar:heart-bold", link: '/profile/wishlist'},
    { id: 'account', name: 'Account Setting', icon: "heroicons:user-circle", link: '/profile/account-setting' },
    { id: 'kyc', name: 'E_Kyc', icon: "heroicons:shield-check", link: '/profile/e-kyc' },
  ];
  ...
  return (
    <>
      ...
      <div className={`
        ...
        w-[280px] sm:w-64 md:translate-x-0 md:static md:block
            ...
            return (
              ...
              >
                <div className="flex items-center space-x-4">
                   <div className={isActive ? 'text-white' : 'text-gray-500 group-hover:text-black'}>
