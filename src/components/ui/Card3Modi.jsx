...
//       {/* Image Section */}
//       <div className="relative aspect-[4/5] m-1.5 sm:m-2 overflow-hidden rounded-[18px] sm:rounded-[24px] bg-[#F7F7F7]">
//         <img
//           src={product.image}
//           alt={product.title}
...
//           className="absolute top-2 right-2 sm:top-3 sm:right-3 p-1.5 sm:p-2 bg-white/80 backdrop-blur-sm rounded-full text-gray-500 hover:text-red-500 transition-all shadow-sm active:scale-90"
//         >
...
//           <span className="text-[9px] sm:text-[10px] font-semibold uppercase tracking-widest text-gray-400 truncate max-w-[60%]">
...
//             <span className="text-lg sm:text-sm font-bold text-red-600 leading-none">{displayPrice}</span>
//             {displayOriginal && (
//               <span className="text-[10px] sm:text-xs text-gray-00 line-through mt-0.5">{displayOriginal}</span>
//             )}
//           </div>
...
//         {/* Mobile/Tablet Visible Button: Shown below 1024px */}
//         <button 
//           onClick={handleAddToCart}
