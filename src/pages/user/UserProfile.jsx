...
const UserProfile = ({ user, stats, loading }) => {
  const mapUserToState = (u) => ({
    ...
    referralCode: u?.referralCode || u?.referral_code || "N/A"
  });
  ...
  return (
    <div className="w-full bg-[#F9F9F9]">
      <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex-1 w-full overflow-hidden">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-y-10 gap-x-6">
                ...
                <div className="flex flex-col gap-1 overflow-hidden sm:col-span-2 lg:col-span-1">
                  ...
                  <span className="text-sm font-bold text-gray-700 break-all">{email}</span>
                </div>
        ...
        {/* STATS SECTION */}
        {loading ? (
          <div className="flex justify-center p-10 py-20 bg-white rounded-3xl shadow-sm border border-gray-100">
...
// import { userDashboardStats } from "../../utils/service/apiService"; 
...
//         const response = await userDashboardStats(token);
